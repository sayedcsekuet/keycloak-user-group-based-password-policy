...
abstract public class PolicyProviderMultiplexer implements PasswordPolicyProvider {
    ...
    abstract protected String findPolicies(RealmModel realm, UserModel user);
    ...
    public PolicyError validate(RealmModel realm, UserModel user, String password) {
        ...
        PasswordPolicy policy = PolicyCollector.parsePolicy(this.session, findPolicies(realm, user));
        LinkedList<PolicyError> list = new LinkedList<>(validateSubPolicy(policy, realm, user, password));
